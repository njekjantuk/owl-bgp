...
public class TurtleParser implements TurtleParserConstants {
    ...
    public static final String SPARQL_VAR_PREFIX="http://www.w3.org/2008/01/sparql#";
    
    protected boolean ignoreAnnotationsAndDeclarations=true;
    protected String base;
    protected int blankNodeId;
    protected TripleHandler handler;
    protected Prefixes pm=new Prefixes();
...
//}
  ...
  final public String parseItemList() throws ParseException {
    ...
    String subject=null;
    String type=OWLRDFVocabulary.RDF_TYPE.getIRI();
    String first=OWLRDFVocabulary.RDF_FIRST.getIRI();
    String rest=OWLRDFVocabulary.RDF_REST.getIRI();
    String list=OWLRDFVocabulary.RDF_LIST.getIRI();
    String nil=OWLRDFVocabulary.RDF_NIL.getIRI();
    label_4:
    while (true) {
      if (jj_2_31(2)) {
        ;
