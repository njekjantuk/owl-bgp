...
import org.semanticweb.sparql.owlbgpparser.translators.ClassExpressionListItemTranslator;
import org.semanticweb.sparql.owlbgpparser.translators.ClassExpressionTranslator;
import org.semanticweb.sparql.owlbgpparser.translators.ClassExpressionTranslatorSelector;
import org.semanticweb.sparql.owlbgpparser.translators.DataPropertyListItemTranslator;
import org.semanticweb.sparql.owlbgpparser.translators.DataRangeListItemTranslator;
import org.semanticweb.sparql.owlbgpparser.translators.FacetRestrictionListItemTranslator;
import org.semanticweb.sparql.owlbgpparser.translators.IndividualListItemTranslator;
import org.semanticweb.sparql.owlbgpparser.translators.ObjectPropertyListItemTranslator;
...
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPAllValuesFromHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPComplementOfHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPDataPropertDomainHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPDataPropertyRangeHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPDisjointDataPropertiesHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPDisjointObjectPropertiesHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPDisjointUnionHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPDisjointWithHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPDistinctMembersHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPEquivalentClassHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPEquivalentDataPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPEquivalentObjectPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPEquivalentPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPFirstLiteralHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPFirstResourceHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPHasKeyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPImportsHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPIntersectionOfHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPInverseOfHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPObjectPropertyDomainHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPObjectPropertyRangeHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPOnPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPOneOfHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPPropertyChainAxiomHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPPropertyDisjointWithHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPPropertyDomainHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPPropertyRangeHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPRestHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPSameAsHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPSomeValuesFromHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPSubClassOfHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPSubDataPropertyOfHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPSubObjectPropertyOfHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPSubPropertyOfHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPTypeHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPUnionOfHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.builtinpredicate.TPVersionIRIHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.general.GTPAnnotationLiteralHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.general.GTPAnnotationResourceTripleHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.general.GTPDataPropertyAssertionHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.general.GTPObjectPropertyAssertionHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.BuiltInTypeHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeAllDifferentHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeAllDisjointClassesHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeAllDisjointPropertiesHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeAnnotationHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeAnnotationPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeAsymmetricPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeAxiomHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeClassHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeDataPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeDataRangeHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeDatatypeHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeFunctionalDataPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeFunctionalObjectPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeFunctionalPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeInverseFunctionalPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeIrreflexivePropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeListHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeNamedIndividualHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeNegativePropertyAssertionHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeObjectPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeOntologyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeReflexivePropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeRestrictionHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeSymmetricPropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypeTransitivePropertyHandler;
import org.semanticweb.sparql.owlbgpparser.triplehandlers.rdftype.TypedConstantListItemTranslator;
...
//        addBuiltInTypeTripleHandler(new TypeDeprecatedPropertyHandler(this));
    ...
    public void addClass(Identifier iri) {
        if (isVariable(iri)) classVariables.add(iri);
        else if (!isAnonymous(iri)) classIRIs.add(iri);
    }
    public void addObjectProperty(Identifier iri) {
        if (isVariable(iri)) objectPropertyVariables.add(iri);
        else objectPropertyIRIs.add(iri);
    }
    public void addDataProperty(Identifier iri) {
        if (isVariable(iri)) dataPropertyVariables.add(iri);
        else dataPropertyIRIs.add(iri);
    }
    public void addIndividual(Identifier iri) {
        if (isVariable(iri)) individualVariables.add(iri);
    ...
    public void addAnnotationProperty(Identifier iri) {
        if (isVariable(iri)) annotationPropertyVariables.add(iri); 
