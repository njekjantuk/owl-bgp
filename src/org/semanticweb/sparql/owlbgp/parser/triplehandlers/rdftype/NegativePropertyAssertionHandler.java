...
public class NegativePropertyAssertionHandler extends BuiltInTypeHandler {
    ...
    public void handleTriple(Identifier subject, Identifier predicate, Identifier object, Set<Annotation> annotations) {
        ...
        if (triple==null)
            ...
            Individual ind=consumer.getIndividualForIndividualIdentifier(triple[0]);
            if (ind==null) 
            ...
            if (triple[2] instanceof Literal) {
                DataPropertyExpression dpe=consumer.getDataPropertyExpressionForDataPropertyIdentifier(triple[1]);
                if (dpe==null) 
                ...
                consumer.addAxiom(NegativeDataPropertyAssertion.create(dpe,ind,(Literal)triple[2],annotations));
            } else {
                ObjectPropertyExpression ope=consumer.getObjectPropertyExpressionForObjectPropertyIdentifier(triple[1]);
                if (ope==null) 
                ...
                Individual ind2=consumer.getIndividualForIndividualIdentifier(triple[2]);
                if (ind2==null) 
