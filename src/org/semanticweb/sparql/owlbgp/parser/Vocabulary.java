...
public class Vocabulary {
    ...
    public static final IRI RDFS_LITERAL=IRI.create(Prefixes.s_semanticWebPrefixes.get("rdfs")+"Literal");
    public static final IRI RDF_PLAIN_LITERAL=IRI.create(Prefixes.s_semanticWebPrefixes.get("rdf")+"PlainLiteral");
    ...
    public static final IRI RDF_XML_LITERAL=IRI.create(Prefixes.s_semanticWebPrefixes.get("rdf")+"XMLLiteral");
    ...
    static {
        ...
        BUILT_IN_VOCABULARY_IRIS.add(OWL_THING);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_NOTHING);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_CLASS);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ONTOLOGY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ONTOLOGY_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_IMPORTS);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_VERSION_IRI);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_VERSION_INFO);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_EQUIVALENT_CLASS);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_OBJECT_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DATA_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DATATYPE_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_FUNCTIONAL_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_INVERSE_FUNCTIONAL_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ASYMMETRIC_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_SYMMETRIC_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_RESTRICTION);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ON_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_INTERSECTION_OF);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_UNION_OF);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ALL_VALUES_FROM);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_SOME_VALUES_FROM);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_HAS_VALUE);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DISJOINT_WITH);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ONE_OF);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_HAS_SELF);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DISJOINT_UNION_OF);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_MIN_CARDINALITY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_MIN_QUALIFIED_CARDINALITY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_CARDINALITY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_QUALIFIED_CARDINALITY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ANNOTATION_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ANNOTATION);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_INDIVIDUAL);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_LITERAL);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_NAMED_INDIVIDUAL);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DATATYPE);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_SUBCLASS_OF);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_SUB_PROPERTY_OF);
        BUILT_IN_VOCABULARY_IRIS.add(RDF_TYPE);
        BUILT_IN_VOCABULARY_IRIS.add(RDF_NIL);
        BUILT_IN_VOCABULARY_IRIS.add(RDF_REST);
        BUILT_IN_VOCABULARY_IRIS.add(RDF_FIRST);
        BUILT_IN_VOCABULARY_IRIS.add(RDF_LIST);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_MAX_CARDINALITY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_MAX_QUALIFIED_CARDINALITY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_NEGATIVE_PROPERTY_ASSERTION);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_LABEL);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_COMMENT);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_SEE_ALSO);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_IS_DEFINED_BY);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_RESOURCE);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_LITERAL);
        BUILT_IN_VOCABULARY_IRIS.add(RDF_PLAIN_LITERAL);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_DATATYPE);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_TRANSITIVE_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_REFLEXIVE_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_IRREFLEXIVE_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_INVERSE_OF);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_COMPLEMENT_OF);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DATATYPE_COMPLEMENT_OF);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ALL_DIFFERENT);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DISTINCT_MEMBERS);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_SAME_AS);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DIFFERENT_FROM);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DEPRECATED_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_EQUIVALENT_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DEPRECATED_CLASS);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DATA_RANGE);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_DOMAIN);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_RANGE);
        BUILT_IN_VOCABULARY_IRIS.add(RDFS_CLASS);
        BUILT_IN_VOCABULARY_IRIS.add(RDF_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(RDF_DESCRIPTION);
        BUILT_IN_VOCABULARY_IRIS.add(RDF_XML_LITERAL);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_PRIOR_VERSION);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DEPRECATED);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_BACKWARD_COMPATIBLE_WITH);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_INCOMPATIBLE_WITH);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_OBJECT_PROPERTY_DOMAIN);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DATA_PROPERTY_DOMAIN);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DATA_PROPERTY_RANGE);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_OBJECT_PROPERTY_RANGE);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_SUB_OBJECT_PROPERTY_OF);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_SUB_DATA_PROPERTY_OF);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DISJOINT_DATA_PROPERTIES);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_DISJOINT_OBJECT_PROPERTIES);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_PROPERTY_DISJOINT_WITH);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_EQUIVALENT_DATA_PROPERTIES);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_EQUIVALENT_OBJECT_PROPERTIES);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_FUNCTIONAL_DATA_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_FUNCTIONAL_OBJECT_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ON_CLASS);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ON_DATA_RANGE);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ON_DATA_TYPE);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_WITH_RESTRICTIONS);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_INVERSE_OBJECT_PROPERTY_EXPRESSION);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_AXIOM);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_PROPERTY_CHAIN_AXIOM);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ALL_DISJOINT_CLASSES);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_MEMBERS);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ALL_DISJOINT_PROPERTIES);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_TOP_OBJECT_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_BOTTOM_OBJECT_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_TOP_DATA_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_BOTTOM_DATA_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_HAS_KEY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ANNOTATED_SOURCE);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ANNOTATED_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ANNOTATED_TARGET);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_SOURCE_INDIVIDUAL);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_ASSERTION_PROPERTY);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_TARGET_INDIVIDUAL);
        BUILT_IN_VOCABULARY_IRIS.add(OWL_TARGET_VALUE);
    }
