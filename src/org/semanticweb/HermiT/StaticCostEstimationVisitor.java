	...
	public class StaticCostEstimationVisitor extends CostEstimationVisitor {
	    ...
	    public StaticCostEstimationVisitor(OWLOntologyGraph graph, Map<Variable,Integer> bindingPositions, List<Atomic[]> candidateBindings) {
