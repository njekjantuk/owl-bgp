...
public class TypeNegativePropertyAssertionHandler extends BuiltInTypeHandler {
    ...
    public void handleTriple(Identifier subject, Identifier predicate, Identifier object) {
        ...
        if (target!=null) { 
            ...
            consumer.addAxiom(NegativeObjectPropertyAssertion.create(prop,sourceInd,targetInd,consumer.translateAnnotations(subject)));
        } else {
            ...
            consumer.addAxiom(NegativeDataPropertyAssertion.create(prop,sourceInd,targetLit,consumer.translateAnnotations(subject)));
        }
