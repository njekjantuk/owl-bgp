...
public class DynamicCostEstimationVisitor implements QueryObjectVisitorEx<double[]> {
...
//    }
    public double[] visit(QO_ClassAssertion queryObject) {
        ...
        double[] currentEstimate=getClassAssertionCost(axiomTemplate, axiomTemplate.getClassExpression(), axiomTemplate.getIndividual(), m_candidateBindings, indVar);
...
/*    protected double[] getClassAssertionCost(ClassExpression ce, Individual ind, Set<Variable> unbound, Variable indVar) {
    ...
    public double[] visit(QO_ObjectPropertyAssertion queryObject) {
        ...
        double[] currentEstimate=getObjectPropertyAssertionCost(axiomTemplate, (ObjectProperty)axiomTemplate.getObjectPropertyExpression(), axiomTemplate.getIndividual1(), axiomTemplate.getIndividual2(), m_candidateBindings, opVar);
        estimate[0]+=currentEstimate[0];
        estimate[1]+=currentEstimate[1];
